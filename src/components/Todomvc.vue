<template>
    <div class="content">
        ...
        <div class="footer">
            <ul>
                <li>
                    <input type="radio" name="listType" id="all" @click="changeList('all')" checked><label for="all">All</label>
                </li>
                <li>
                    <input type="radio" name="listType" id="active" @click="changeList('active')"><label for="active">Active</label>
                </li>
                <li>
                    <input type="radio" name="listType" id="complete" @click="changeList('complete')"><label for="complete">Complete</label>
                </li>
            </ul>
